...
import 'custom_calender_picker.dart';
...
class _DatePickerDialogState extends State<DatePickerDialog> with RestorationMixin {
  ...
  void _handleDateChanged(DateTime date) {
    if(_selectedDates.where((e)=>DateUtils.isSameDay(e, date)).isEmpty){
      setState(() {
      ...
      _selectedDates.remove(_selectedDates.where((e)=>DateUtils.isSameDay(e, date)).first);
    }

    widget.onDatesSelected!(_selectedDates);
    debugPrint("dsds"+_selectedDates.toString());
  ...
  Widget build(BuildContext context) {
    debugPrint("dsccvfd"+_selectedDates.toString());
