...
class CustomCalendarDatePicker extends StatefulWidget {
  ...
  /// change the [key] to create a new instance of the [CustomCalendarDatePicker], and
...
class _CustomCalendarDatePickerState extends State<CustomCalendarDatePicker> {
  ...
  Widget _buildPicker() {
    debugPrint("asfxcv"+widget.selectedDates.toString());
    switch (_mode) {
  ...
  Widget build(BuildContext context) {
    ...
    assert(debugCheckHasMaterialLocalizations(context));
    assert(debugCheckHasDirectionality(context));
    debugPrint("sadxcxcx"+widget.selectedDates.toString());
    return Stack(
      children: <Widget>[
        SizedBox(
...
class _MonthPickerState extends State<_MonthPicker> {
  ...
  Widget _buildItems(BuildContext context, int index) {
    ...
    debugPrint("fssv"+widget.selectedDates.toString());
    return _DayPicker(
...
class _DayPickerState extends State<_DayPicker> {
  ...
  @override
  Widget build(BuildContext context) {
    debugPrint("sdadsad"+widget.selectedDates.toString());
    ...
    while (day < daysInMonth) {
      ...
      if (day < 1) {
        ...
        final bool isSelectedDay = widget.selectedDates!.where((e)=> DateUtils.isSameDay(e, dayToBuild)).isNotEmpty;
...
class _DayState extends State<_Day> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color? dayBackgroundColor = resolve<Color?>((DatePickerThemeData? theme) =>widget.isSelectedDay?MaterialStateProperty.all(Colors.blue): widget.isToday ? theme?.todayBackgroundColor : theme?.dayBackgroundColor, states);
...
/// [CustomCalendarDatePicker], or [showDatePicker] which create full date pickers.
///
/// See also:
///
